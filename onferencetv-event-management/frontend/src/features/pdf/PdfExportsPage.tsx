    ...
    <div className="p-8 max-w-9xl mx-auto pb-24">
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">
          Manage and preview all generated PDF documents for your events.
        </p>
      </div>
          ...
          <div className="flex-1 p-8 overflow-y-auto flex justify-center bg-slate-100 dark:bg-zinc-900/50">
            ...
            <div className="bg-white dark:bg-zinc-900 w-full max-w-[595px] min-h-[842px] shadow-lg border p-12 relative">
              <div className="flex justify-between items-start mb-12">
                <div>
                  <h1 className="text-3xl font-serif text-slate-900 dark:text-white font-bold">
                    {previewItem?.eventName}
                  </h1>
                ...
                <div className="text-right">
                  ...
                  <p className="text-xs text-slate-500">
                    Date:{" "}
                    {previewItem
                      ? format(new Date(previewItem.timestamp), "MMM dd, yyyy")
                      : ""}
                  </p>
                </div>
              </div>
